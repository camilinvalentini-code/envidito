-- DNI, teléfono y mail eran opcionales en la auto-inscripción — solo se
-- validaba el formato si se cargaban. Ahora son obligatorios, igual que
-- la fecha de nacimiento, tanto acá (servidor, la validación real)
