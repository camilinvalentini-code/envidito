-- anotarse_equipo estaba gateada a torneos organizados por una cuenta
-- con role = 'admin' — a propósito, para probarla primero antes de
-- ofrecérsela a los organizadores en general (ver
-- supabase-patch-autoinscripcion.sql). Ya se probó bastante hoy, y con
-- una segunda cuenta (otro bar) necesitando auto-inscripción, se saca
-- el candado: ahora funciona para cualquier organizador.
