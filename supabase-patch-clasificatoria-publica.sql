-- Le saca el candado de admin a la clasificatoria previa — ya se probó
-- de punta a punta (armar cruces, jugar, agregar/sacar equipos sobre
-- la marcha, cerrar y armar el cuadro final) y queda disponible para
-- cualquier organizador en modo Vidón, no solo para torneos del admin
-- de la plataforma.
