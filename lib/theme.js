...
export function ThemeProvider({ children }) {
  ...
  useEffect(() => {
    ...
    // Sin preferencia explícita todavía: el anotador (de torneo o suelto)
    // arranca en oscuro por defecto, el resto del sitio sigue en claro.
    const esAnotador = pathname?.startsWith("/anotador") || pathname?.startsWith("/partido/");
    setTheme(esAnotador ? "dark" : "light");
  }, [pathname]);
