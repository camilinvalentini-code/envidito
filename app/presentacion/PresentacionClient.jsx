...
const CSS = `
  ...
  #presentacion-root .bracket-pair{ min-width:0; width:170px; max-width:100%; border:1px solid var(--line); border-radius:12px; overflow:hidden; }
  #presentacion-root .bracket-row > .bracket-pair{ flex:1 1 0; }
    ...
    <div id="presentacion-root">
      ...
      <section id="close">
        ...
        <div className="close-links reveal d3">
          <a
            href="https://wa.me/5493493461418?text=Hola!%20Quiero%20armar%20un%20torneo%20en%20mi%20bar"
            target="_blank"
            rel="noreferrer"
          >
